 ...
 */
function margaritaandco_preprocess_search_result(&$variables) {
...
function margaritaandco_uc_payment_totals($variables) {
...
function margaritaandco_uc_cart_checkout_review($variables) {
...
/*function margaritaandco_form_alter(&$form, &$form_state, $form_id) {
  dsm($form_id);
  if($form_id == 'uc_cart_checkout_form'){
    if(isset($form['panes']['coupon']['coupons']['#default_value'][0])){
      uc_quote_apply_quote_to_order($form, $form_state);  
	dsm($form);
    }
  }  
}*/
/*function margaritaandco_uc_cart_alter(&$items) {
  dsm($items);
}*/
